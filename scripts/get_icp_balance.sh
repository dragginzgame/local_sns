#!/bin/bash
# Script to get ICP ledger balance for an account
#
# Usage:
...
#   bash scripts/get_icp_balance.sh 2laou-ygqmf-...
#   bash scripts/get_icp_balance.sh 2laou-ygqmf-... 0xabcd1234...
